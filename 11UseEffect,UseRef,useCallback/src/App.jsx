...
function App() {
  ...
  const CopyClipBoard = useCallback(() => {
    passWordRef.current?.select()//object selected
    passWordRef.current?.setSelectionRange(0,100)//selecting range value
  ...
  return (
    <>
      <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 my-8 text-orange-500 bg-gray-1000">
